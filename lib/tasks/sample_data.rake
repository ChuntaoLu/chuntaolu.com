...
def make_articles
  50.times do
    ...
    Article.create!(title: title, body: content, tag_list: tag_list)
  end
end

def make_microposts
  50.times do
    content = Faker::Lorem.sentence(word_count = 10, random_words_to_add = 10)
    tag_list = Faker::Lorem.words(3)
...
def make_moocs
  10.times do
    name = Faker::Lorem.sentence(word_count = 5, random_words_to_add = 3)
